...
const Hero = () => {
  return (
    <div className='relative w-full h-[120vh] sm:h-[100vh] mt-14 bg-black text-white'>
      <div className='w-[90%] xl:w-[80%] m-auto flex flex-wrap pt-5'>
         <div className='w-full lg:w-1/2 '>
            <div className='flex flex-col items-center lg:items-start'>
              ...
              <p className='my-2 max-w-xl py-6 font-light tracking-tighter'>Iam a passionate Full Stack Web Developer, I specialize in creating dynamic and responsive web applications 
         ...
         <div className='w-full lg:w-1/2 lg:pt-10 lg:p-15 p-5 '>
