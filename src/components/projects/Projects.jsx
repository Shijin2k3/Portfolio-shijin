           ...
           <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 items-center gap-8 mb-12'>
              ...
              <div className='rounded-2xl border-4 border-cyan-400 p-4 hover:shadow-lg transform transition-transform
                   ...
                   <div className='flex flex-col items-center mb-4'>
                     <h1 className='mb-2 mt-4 md:text-2xl font-bold  text-transparent bg-clip-text
                             bg-gradient-to-r from-green-400 to-blue-500 text-center uppercase'>Travel- Website</h1>
                      <p className='text-sm md:text-lg text-gray-300'>NEXT JS </p>
                   </div>
              ...
              <div className='rounded-2xl border-4 border-cyan-400 p-4 hover:shadow-lg transform transition-transform
                   ...
                   <div className='flex flex-col items-center mb-4'>
                     <h1 className='mb-2 mt-4 md:text-2xl font-bold  text-transparent bg-clip-text
                      ...
                      <p className='text-sm md:text-lg text-gray-300'>REACT JS</p>
                   </div>
                   <div className='flex flex-row justify-between gap-4 md:gap-20 mb-2 md:mb-4'>
              ...
              <div className='rounded-2xl border-4 border-cyan-400 p-4 hover:shadow-lg transform transition-transform
                   ...
                   <div className='flex flex-col items-center mb-4'>
                     <h1 className='mb-2 mt-4 md:text-2xl font-bold  text-transparent bg-clip-text
                      ...
                      <p className='text-sm md:text-lg text-gray-300'>MERN STACK</p>
                   </div>
                   <div className='flex flex-row justify-between gap-4 md:gap-20 mb-2 md:mb-4'>
              ...
              <div className='rounded-2xl border-4 border-cyan-400 p-4 hover:shadow-lg transform transition-transform
                   ...
                   <div className='flex flex-col items-center mb-4'>
                     <h1 className='mb-2 mt-4 md:text-2xl font-bold  text-transparent bg-clip-text
                      ...
                      <p className='text-sm md:text-lg text-gray-300'>HTML,CSS,JS</p>
                   </div>
                   <div className='flex flex-row justify-between gap-4 md:gap-20 mb-2 md:mb-4'>
